({
    ...
    fetchConversationData: function(component, event, helper, conversationId, appState){
        ...
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") { 
                ...
                this.handleStageChange(component, event, helper, appState.stage, appState);    
