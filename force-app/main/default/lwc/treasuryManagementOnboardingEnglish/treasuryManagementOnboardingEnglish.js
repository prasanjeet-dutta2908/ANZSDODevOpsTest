...
import { OMNIDEF } from './treasuryManagementOnboardingEnglish_def.js';
import tmpl from './treasuryManagementOnboardingEnglish.html';
import tmpl_nds from './treasuryManagementOnboardingEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class treasuryManagementOnboardingEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
