...
import getTasks from '@salesforce/apex/demCalendarController.getTasks';
import getEvents from '@salesforce/apex/demCalendarController.getEvents';
import getOpportunities from '@salesforce/apex/demCalendarController.getOpportunities';
...
export default class DemActivityCalendarWrapper extends LightningElement {
    ...
    @api size = '1';
    @api labelToday;
    @api labelTitle = 'Quarterly Calendar';
    @api labelDaysOfWeek = DAYS_OF_WEEK.join(',');
    @api labelsForTask = LABELS_TASK.join(',');
    @api labelsForEvent = LABELS_EVENT.join(',');
