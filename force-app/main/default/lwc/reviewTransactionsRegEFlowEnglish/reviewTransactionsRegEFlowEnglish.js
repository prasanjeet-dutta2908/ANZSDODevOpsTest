...
import { OMNIDEF } from './reviewTransactionsRegEFlowEnglish_def.js';
import tmpl from './reviewTransactionsRegEFlowEnglish.html';
import tmpl_nds from './reviewTransactionsRegEFlowEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class reviewTransactionsRegEFlowEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
