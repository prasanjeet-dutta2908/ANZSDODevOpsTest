...
import { OMNIDEF } from './treasuryManagementDomesticPaymentsKYCEnglish_def.js';
import tmpl from './treasuryManagementDomesticPaymentsKYCEnglish.html';
import tmpl_nds from './treasuryManagementDomesticPaymentsKYCEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class treasuryManagementDomesticPaymentsKYCEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
