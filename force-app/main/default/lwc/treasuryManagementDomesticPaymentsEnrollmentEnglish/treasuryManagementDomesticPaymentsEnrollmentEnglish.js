...
import { OMNIDEF } from './treasuryManagementDomesticPaymentsEnrollmentEnglish_def.js';
import tmpl from './treasuryManagementDomesticPaymentsEnrollmentEnglish.html';
import tmpl_nds from './treasuryManagementDomesticPaymentsEnrollmentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class treasuryManagementDomesticPaymentsEnrollmentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
