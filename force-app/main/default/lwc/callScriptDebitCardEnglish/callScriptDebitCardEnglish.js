...
import { OMNIDEF } from './callScriptDebitCardEnglish_def.js';
import tmpl from './callScriptDebitCardEnglish.html';
import tmpl_nds from './callScriptDebitCardEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class callScriptDebitCardEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
