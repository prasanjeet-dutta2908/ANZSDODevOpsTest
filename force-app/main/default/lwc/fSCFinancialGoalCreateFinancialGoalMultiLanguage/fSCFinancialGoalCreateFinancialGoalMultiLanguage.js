...
import { OMNIDEF } from './fSCFinancialGoalCreateFinancialGoalMultiLanguage_def.js';
import tmpl from './fSCFinancialGoalCreateFinancialGoalMultiLanguage.html';
import tmpl_nds from './fSCFinancialGoalCreateFinancialGoalMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class fSCFinancialGoalCreateFinancialGoalMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
