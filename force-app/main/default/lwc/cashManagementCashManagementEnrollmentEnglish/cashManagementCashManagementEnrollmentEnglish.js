...
import { OMNIDEF } from './cashManagementCashManagementEnrollmentEnglish_def.js';
import tmpl from './cashManagementCashManagementEnrollmentEnglish.html';
import tmpl_nds from './cashManagementCashManagementEnrollmentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cashManagementCashManagementEnrollmentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
