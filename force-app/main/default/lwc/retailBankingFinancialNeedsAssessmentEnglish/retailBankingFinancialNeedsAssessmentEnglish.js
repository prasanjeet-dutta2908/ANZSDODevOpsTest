...
import { OMNIDEF } from './retailBankingFinancialNeedsAssessmentEnglish_def.js';
import tmpl from './retailBankingFinancialNeedsAssessmentEnglish.html';
import tmpl_nds from './retailBankingFinancialNeedsAssessmentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class retailBankingFinancialNeedsAssessmentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
