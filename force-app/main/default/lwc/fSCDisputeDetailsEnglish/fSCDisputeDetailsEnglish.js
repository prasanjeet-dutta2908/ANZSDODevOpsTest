...
import { OMNIDEF } from './fSCDisputeDetailsEnglish_def.js';
import tmpl from './fSCDisputeDetailsEnglish.html';
import tmpl_nds from './fSCDisputeDetailsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class fSCDisputeDetailsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
