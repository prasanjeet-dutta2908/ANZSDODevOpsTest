...
import { OMNIDEF } from './fSCFinancialGoalFinancialGoalDetailsMultiLanguage_def.js';
import tmpl from './fSCFinancialGoalFinancialGoalDetailsMultiLanguage.html';
import tmpl_nds from './fSCFinancialGoalFinancialGoalDetailsMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class fSCFinancialGoalFinancialGoalDetailsMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
